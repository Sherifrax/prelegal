...
// Mechanically generated from ../../../../templates/BAA.md
...
export const standardTermSections: StandardTermSection[] = [
  {
    ...
    body: `**Obligations and Restrictions.** Provider may not use or disclose PHI other than as described in this BAA, as permitted under the Privacy Rule, or as otherwise required by applicable law.
...
**Compliance with Covered Entity’s Obligations.** To the extent that Provider carries out Company's obligations under the Privacy Rule, Provider will comply with the requirements of the relevant Privacy Rule regulations that apply to Company in the performance of such obligations.`,
  },
  {
    ...
    body: `**Notice of Privacy Practices.** Upon request, Company will provide Provider with its current notice of privacy practices adopted as required by the Privacy Rule. Company will notify Provider if any limitations in its notice of privacy practices impact Provider's use or disclosure of PHI under the BAA.
...
**Compliance with Laws.** Company will only use and disclose PHI to Provider in accordance with its obligations under HIPAA and with applicable law.`,
  },
  {
    ...
    body: `**Offshoring PHI.** Except as restricted by applicable {{Limitations}}, Provider is permitted to use and disclose PHI outside of the United States to provide the Services.
...
**Confidentiality.** Provider will not disclose information related to a Security Incident except as required by applicable law.`,
  },
  {
    ...
    body: `**Term.** This BAA will start on the {{BAA Effective Date}} and will continue in effect until the later of when all obligations of the parties have been met under this BAA or when the Agreement ends or expires.
...
(b) Provider may not retain any copies of PHI unless directed to do so by Company. However, if neither return nor destruction are feasible, Provider may retain PHI as long as Provider continues to comply with all provisions of this BAA for the time it retains PHI and limits the use or disclosure of retained PHI to those purposes that made the return or destruction of PHI infeasible.`,
  ...
  {
    title: `Definitions`,
    body: `**Defining Variables.** Variables have the meanings or descriptions given on the Cover Page. However, if the Cover Page omits or does not define a Variable, the default meaning will be "none" or "not applicable" and the correlating clause, sentence, or section does not apply to the BAA.
