...
**Customer Obligations.** Customer will comply with Customer Obligations, if any.`,
  },
  {
    ...
    body: `**Deliverables.** Except for Pre-Existing Materials and Third-Party Materials, Provider assigns all right, title, and interest in the Deliverables (if any) to Customer at the Time of Assignment. Upon the Time of Assignment, Provider will assert no rights over such Deliverables.
...
**Reservation of Rights.** Except for (a) Customer's ownership of Deliverables (if any) under Section 2.1 (Deliverables); (b) Provider's rights to use Customer Materials in Section 2.2 (Customer Materials); and (c) Customer's rights to Pre-Existing Materials in Section 2.3 (Pre-Existing Materials), neither party transfers any rights in any of their products, data, or any other intellectual property.`,
  },
  {
    ...
    body: `**Personal Data.** If the parties have a DPA, each party will comply with its obligations in the DPA, the terms of the DPA will control each party’s rights and obligations as to Personal Data, and the terms of the DPA will control in the event of any conflict with this Agreement.

**Security.** Provider will comply with the Security Policy, if any.`,
  },
  {
    title: `Payment & Taxes`,
    body: `**Fees and Invoices.** Unless the currency is specified in the SOW, all Fees are in U.S. Dollars and are exclusive of taxes. Except for the prorated refund of prepaid Fees allowed with specific termination rights, Fees are non-refundable. Provider will send invoices for Fees as described in the SOW.
...
**Payment Dispute.** If Customer has a good-faith disagreement about the amounts charged on an invoice, Customer must notify Provider about the dispute during the {{Payment Period}} for the invoice and must pay all undisputed amounts on time. The parties will work together to resolve the dispute within 15 days after the end of the {{Payment Period}}. If no resolution is agreed, each party may pursue any remedies available under the Agreement, the applicable SOW, or Applicable Laws.`,
  },
  {
    ...
    body: `**Term.** This Agreement will start on the {{Effective Date}} and continue until 12 months have elapsed since the end of the latest SOW Term end date.
...
(b) Each Recipient may retain Discloser’s Confidential Information in accordance with its standard backup or record retention policies maintained in the ordinary course of business or as required by Applicable Laws, in which case Section 3 (Privacy & Security) and Section 11 (Confidentiality) will continue to apply to retained Confidential Information.`,
  },
  {
    ...
    body: `**Mutual.** Each party represents and warrants to the other that: (a) it has the legal power and authority to enter into this Agreement; (b) it is duly organized, validly existing, and in good standing under the Applicable Laws of the jurisdiction of its origin; (c) it will comply with all Applicable Laws in performing its obligations or exercising its rights in this Agreement; and (d) it will comply with the {{Additional Warranties}}

**From Customer.** Customer represents and warrants to Provider that (a) Provider's use of Customer Materials and Customer-procured Third-Party Materials under this Agreement does not and will not infringe or misappropriate anyone else's copyright, trademark, trade secret, or right of publicity; and (b) it has all rights necessary to provide Customer Materials and Customer-procured Third-Party Materials under Section 2.
...
**Assignment.** Neither party may assign any rights or obligations under this Agreement or any SOW without the prior written consent of the other party. However, Customer may assign this Agreement upon notice if Customer undergoes a merger, change of control, reorganization, or sale of all or substantially all its equity, business, or assets to which this Agreement relates. Any attempted but non-permitted assignment is void. This Agreement will be binding upon and inure to the benefit of the parties and their permitted successors and assigns.

**No Publicity.** Neither party may publicly announce the existence of this Agreement or any SOW without the prior written approval of the other party.
...
**Signature.** This Agreement may be signed in counterparts, including by electronic copies or acceptance mechanism. Each copy will be deemed an original and all copies, when taken together, will be the same agreement.`,
  ...
  {
    title: `Definitions`,
    body: `(1) **"Affiliate"** means an entity that, directly or indirectly, controls, is under the control of, or is under common control with a party, where control means having more than fifty percent (50%) of the voting stock or other ownership interest.
