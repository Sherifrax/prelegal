...
// Mechanically generated from ../../../../templates/DPA.md
...
export const standardTermSections: StandardTermSection[] = [
  {
    ...
    body: `**Provider as Processor.** In situations where Customer is a Controller of the Customer Personal Data, Provider will be deemed a Processor that is Processing Personal Data on behalf of Customer.
...
**Provider as Subprocessor.** In situations where Customer is a Processor of the Customer Personal Data, Provider will be deemed a Subprocessor of the Customer Personal Data.`,
  ...
  {
    title: `Processing`,
    body: `**Processing Details.** Annex I(B) on the Cover Page describes the subject matter, nature, purpose, and duration of this Processing, as well as the {{Categories of Personal Data}} collected and {{Categories of Data Subjects}}.
...
(b) If Customer and Provider have entered the EEA SCCs or the UK Addendum as part of this DPA, Provider will only give Customer the certification of deletion of Personal Data described in Clause 8.1(d) and Clause 8.5 of the EEA SCCs if Customer asks for one.`,
  },
  {
    ...
    body: `**Liability Caps and Damages Waiver.** **To the maximum extent permitted under Applicable Data Protection Laws, each party’s total cumulative liability to the other party arising out of or related to this DPA will be subject to the waivers, exclusions, and limitations of liability stated in the Agreement.**
...
**Exceptions.** This DPA does not limit any liability to an individual about the individual’s data protection rights under Applicable Data Protection Laws. In addition, this DPA does not limit any liability between the parties for violations of the EEA SCCs or UK Addendum.`,
  },
  {
    ...
    body: `(1) This DPA forms part of and supplements the Agreement. If there is any inconsistency between this DPA, the Agreement, or any of their parts, the part listed earlier will control over the part listed later for that inconsistency: (1) the EEA SCCs or the UK Addendum, (2) this DPA, and then (3) the Agreement.`,
  },
  {
    title: `Term of Agreement`,
    body: `(1) This DPA will start when Provider and Customer agree to a Cover Page for the DPA and sign or electronically accept the Agreement and will continue until the Agreement expires or is terminated. However, Provider and Customer will each remain subject to the obligations in this DPA and Applicable Data Protection Laws until Customer stops transferring Customer Personal Data to Provider and Provider stops Processing Customer Personal Data.`,
  },
  {
    title: `Definitions`,
    body: `(1) **"Applicable Laws"** means the laws, rules, regulations, court orders, and other binding requirements of a relevant government authority that apply to or govern a party.
