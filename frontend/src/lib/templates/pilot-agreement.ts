...
// Mechanically generated from ../../../../templates/Pilot-Agreement.md
...
export const standardTermSections: StandardTermSection[] = [
  {
    title: `Pilot Access`,
    body: `**Access and Use.** During the {{Pilot Period}} and subject to the terms of this Agreement, Customer may access and use the Product solely for Customer's Evaluation Purposes.
...
**Reservation of Rights.** Except for the limited license to install and use Software in Section 1.2 (License), Provider retains all right, title, and interest in and to the Product, whether developed before or after the {{Effective Date}}. Except for the limited rights in Section 1.4 (Customer Content), Customer retains all right, title, and interest in and to the Customer Content.`,
  },
  {
    ...
    body: `**Agreement.** The Agreement will start on the {{Effective Date}} and, unless terminated earlier according to the terms of this Agreement, will continue through the {{Pilot Period}}.
...
(b) Each Recipient may retain Discloser’s Confidential Information in accordance with its standard backup or record retention policies maintained in the ordinary course of business or as required by Applicable Laws, in which case Section 6 (Confidentiality) will continue to apply to retained Confidential Information.`,
  },
  {
    ...
    body: `(1) Each party represents to the other that: (a) it has the legal power and authority to enter into this Agreement; and (b) it is duly organized, validly existing, and in good standing under the Applicable Laws of the jurisdiction of its origin.`,
  },
  {
    title: `Disclaimer of Warranties`,
    body: `(1) Provider makes no guarantees that the Product will always be safe, secure, or error-free, or that it will function without disruptions, delays, or imperfections. **The Product is provided on an "AS IS" and "AS AVAILABLE" basis. Provider disclaims all warranties and conditions, whether express or implied, including the implied warranties and conditions of merchantability, fitness for a particular purpose, title, and non-infringement.** These disclaimers apply to the maximum extent permitted by Applicable Laws.`,
  },
  {
    title: `Limitation of Liability`,
    body: `**General Liability Cap.** **Each party’s total cumulative liability for all claims arising out of or relating to this Agreement will not be more than the {{General Cap Amount}}.**
...
**Applicability.** **The limitations and waivers contained in Sections 5.1 (General Liability Cap) and 5.2 (Damages Waiver) apply to all liability, whether in tort (including negligence), contract, breach of statutory duty, or otherwise.** However, nothing in this Agreement will limit, exclude, or restrict a party's liability to the extent prohibited by Applicable Laws.`,
  },
  {
    ...
    body: `**Non-Use and Non-Disclosure.** Except as otherwise authorized in the Agreement or as needed to fulfill its obligations or exercise its rights under this Agreement, Recipient will not (a) use Discloser’s Confidential Information; nor (b) disclose Discloser’s Confidential Information to anyone else. In addition, Recipient will protect Discloser’s Confidential Information using at least the same protections Recipient uses for its own similar information but no less than a reasonable standard of care.
...
**Signature.** This Agreement may be signed in counterparts, including by electronic copies or acceptance mechanism. Each copy will be deemed an original and all copies, when taken together, will be the same agreement.`,
  ...
  {
    title: `Definitions`,
    body: `**Defining Variables.** Variables have the meanings or descriptions given on the Order Form. However, if the Order Form omits or does not define a Variable, the default meaning will be "none" or "not applicable" and the correlating clause, sentence, or section does not apply to that Agreement.
