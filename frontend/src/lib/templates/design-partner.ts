...
// Mechanically generated from ../../../../templates/design-partner-agreement.md
...
export const standardTermSections: StandardTermSection[] = [
  {
    ...
    body: `**Product Access.** Partner would like to be one of the first users of the Product. During the {{Term}}, Partner will have early access to the Product for its internal business purposes and to give Feedback to Provider and participate in the Program, so long as Partner complies with the terms of this Agreement.

**Program and Feedback.** The purpose of the Program is for Provider to develop, build, and improve the Product for general use by all of Provider's customers or users. Partner will give Feedback to Provider on a mutually agreed schedule and will participate in the Program.

**Product Improvement.** Provider will develop and improve the Product and may use all Feedback and insight about the Product from the Program freely without any restriction or obligation. Partner will not give any Feedback that Provider cannot use in this manner or for the purpose.`,
  },
  {
    title: `Fees and Costs`,
    body: `(1) Partner will pay Provider the {{Fees}}, if any.`,
  },
  {
    title: `Term & Termination`,
    body: `**Agreement Term.** This Agreement will start on the {{Effective Date}} and continue for the {{Term}}. Provider and Partner may mutually agree to extend the {{Term}}, including by email communication.

**Termination.** Either party may terminate this Agreement for any or no reason. To terminate this Agreement, the terminating party must notify the other party about termination by giving the other party 30 days advance notice.
...
(b) Each Recipient may retain Discloser’s Confidential Information in accordance with its standard backup or record retention policies maintained in the ordinary course of business or as required by Applicable Laws, in which case Section 5 (Confidentiality) will continue to apply to retained Confidential Information.`,
  },
  {
    ...
    body: `(1) Provider and Partner each disclaim all warranties, whether express or implied, including the implied warranties of merchantability, fitness for a particular purpose, title, and non-infringement. These disclaimers apply to the maximum extent permitted by Applicable Laws.`,
  },
  {
...
**Permitted Disclosures.** Recipient may disclose Discloser’s Confidential Information to Users, employees, advisors, contractors, and representatives who each have a need to know the Confidential Information, but only if the person or entity is bound by confidentiality obligations at least as protective as those in this Section 5 and Recipient remains responsible for everyone’s compliance with the terms of this Section 5.`,
  },
  {
    ...
    body: `**Reservation of Rights.** Except for the limited license to access the Product in Section 1.1 (Product Access), Provider retains all right, title, and interest in and to the Product, including any aspects, features, or functionality created in response to Feedback or Partner's participation in the Program, whether developed before or after the {{Effective Date}}. Each Discloser retains all right, title, and interest in and to its Confidential Information.

**Ownership.** Provider owns all Feedback. Partner hereby assigns to Provider all its right, title, and interest in and to Feedback and will reasonably cooperate with Provider as needed to establish, prove, or defend Provider's ownership of Feedback.`,
  },
  {
    title: `General Terms`,
    body: `**Entire Agreement.** This Agreement is the only agreement between the parties about its subject and this Agreement supersedes all prior or contemporaneous statements (whether in writing or not) about its subject.
...
**Signature.** This Agreement may be signed in counterparts, including by electronic copies or acceptance mechanism. Each copy will be deemed an original and all copies, when taken together, will be the same agreement.`,
  ...
  {
    title: `Definitions`,
    body: `(1) **"Agreement"** means these Standard Terms, the Cover Page between Provider and Partner, and the policies and documents referenced in or attached to the Cover Page.
